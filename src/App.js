    ...
    <Router>
      <div className="container">
        ...
        <Routes>
          ...
          <Route
            path="/skills"
            element={<Skills content={data.skills} />}
          />
          <Route
            path="/services"
            element={<Services content={data.services} />}
          />
          <Route
            path="/contact"
            element={<Contact content={data.contact} />}
          />
          <Route
            path="/projects"
            element={<Projects content={data.projects} />}
          />
          <Route
            path="/dashboard"
            element={<Dashboard data={data} handleDataChange={handleDataChange} />}
          />
        </Routes>
